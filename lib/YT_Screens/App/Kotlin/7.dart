...
class YoutubePlayerDemo7 extends StatefulWidget {
  YoutubePlayerDemo7({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  _YoutubePlayerDemo7State createState() => _YoutubePlayerDemo7State();
}

class _YoutubePlayerDemo7State extends State<YoutubePlayerDemo7> {
