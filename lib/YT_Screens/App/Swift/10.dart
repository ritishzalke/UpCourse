...
class YoutubePlayerDemo10 extends StatefulWidget {
  YoutubePlayerDemo10({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  _YoutubePlayerDemo10State createState() => _YoutubePlayerDemo10State();
}

class _YoutubePlayerDemo10State extends State<YoutubePlayerDemo10> {
  late YoutubePlayerController _ytbPlayerController;
  List<YoutubeModel> videosList = [
    YoutubeModel(id: 1, youtubeId: 'XzWBT6lIB3A'),
