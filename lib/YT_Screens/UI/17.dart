...
class YoutubePlayerDemo17 extends StatefulWidget {
  YoutubePlayerDemo17({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  _YoutubePlayerDemo17State createState() => _YoutubePlayerDemo17State();
}

class _YoutubePlayerDemo17State extends State<YoutubePlayerDemo17> {
  late YoutubePlayerController _ytbPlayerController;
  List<YoutubeModel> videosList = [
    YoutubeModel(id: 1, youtubeId: '0KEpWHtG10M'),
    YoutubeModel(id: 2, youtubeId: 'ha3a63YjLro'),
    YoutubeModel(id: 3, youtubeId: '1at8XzyeEVA'),
    YoutubeModel(id: 4, youtubeId: 'AVonkBWYeDU'),
    YoutubeModel(id: 5, youtubeId: 'OK00k47RMPI'),
    YoutubeModel(id: 6, youtubeId: 'xIIJfmDnvPE'),
    YoutubeModel(id: 7, youtubeId: 'sTdt2cJS2dg'),
    YoutubeModel(id: 8, youtubeId: 'TtJ3eCLYoRQ'),
    YoutubeModel(id: 9, youtubeId: 'MnIEJMgvuvc'),
    YoutubeModel(id: 10, youtubeId: 'GYTN5JdkLSQ'),
    YoutubeModel(id: 11, youtubeId: 'M75MUZ1zVYM'),
    YoutubeModel(id: 12, youtubeId: 'DSuJLPRsdZQ'),
    YoutubeModel(id: 13, youtubeId: 'Ix1LZGBSp-E'),
    YoutubeModel(id: 14, youtubeId: 'CNh3Q_z9GSw'),
    YoutubeModel(id: 15, youtubeId: '6BkqRkw0Lwc'),
    YoutubeModel(id: 16, youtubeId: '0WbrOfmvjvU'),
    YoutubeModel(id: 17, youtubeId: 'gEbSx5CCgSc'),
    YoutubeModel(id: 18, youtubeId: 'PLzx2thLQaU'),
